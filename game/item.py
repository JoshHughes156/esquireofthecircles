...
class Weapon(Item):
    ...
    @staticmethod
    def damage_calc(weapon, armor, damage_scaling_factor=1.5):
        return weapon.damage # Remove this line to add element type matchups, they need fixing
        ...
        for piece in armor:
            if piece.element != "":
                total += weapon.damage * matchups[weapon.element][piece.element] * piece_contrib[piece.place] * (piece.defense/piece_total_points[piece.place])
